---
name: review-all
description: Multi-stage code review pipeline - runs parallel review agents for comprehensive quality assurance
arguments:
  - name: scope
    description: Scope of review (staged, unstaged, branch, pr, file:<path>)
    required: false
    default: staged
  - name: options
    description: Options (--parallel, --sequential, --quick, --thorough)
    required: false
---
